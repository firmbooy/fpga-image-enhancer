 ...
 *
 * Code generation for function 'laplace_float_mex_emxutil'
 *
 */
...
static void emxCopy_char_T_1x5(emxArray_char_T_1x5 *dst, const
  emxArray_char_T_1x5 *src);
...
{
  emxCopy_char_T_1x5(&dst->Class, &src->Class);
...
/* End of code generation (laplace_float_mex_emxutil.c) */
